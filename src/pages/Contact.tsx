                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid md:grid-cols-2 gap-5">
                      <div>
                        ...
                        <Input
                          ...
                          className="mt-1.5 border-gray-300 focus:border-primary focus:ring-primary/20"
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        className="mt-1.5 border-gray-300 focus:border-primary focus:ring-primary/20 resize-none"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Select value={formData.budget} onValueChange={(value) => setFormData({ ...formData, budget: value })}>
                        <SelectTrigger className="mt-1.5 border-gray-300 focus:border-primary focus:ring-primary/20">
